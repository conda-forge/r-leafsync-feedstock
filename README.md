...
Feedstock license: [BSD-3-Clause](https://github.com/conda-forge/r-leafsync-feedstock/blob/master/LICENSE.txt)
...
<table><tr><td>All platforms:</td>
    <td>
      <a href="https://dev.azure.com/conda-forge/feedstock-builds/_build/latest?definitionId=7922&branchName=master">
        <img src="https://dev.azure.com/conda-forge/feedstock-builds/_apis/build/status/r-leafsync-feedstock?branchName=master">
      </a>
    </td>
  </tr>
</table>
...
Once the `conda-forge` channel has been enabled, `r-leafsync` can be installed with:

```
conda install r-leafsync
```

It is possible to list all of the versions of `r-leafsync` available on your platform with:
